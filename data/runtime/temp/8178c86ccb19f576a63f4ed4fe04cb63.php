<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:48:"D:\WWW\ycm/application/index\view\news\index.htm";i:1574825837;s:44:"D:\WWW\ycm\application\index\view\header.htm";i:1574993737;s:44:"D:\WWW\ycm\application\index\view\footer.htm";i:1574992651;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
			...
			<div class="inner">
				...
				<div class="content">
					<ul class="list">
						...
						<li>
							<a href="/news_detail?aid=<?php echo $v['aid']; ?>" target="_blank">
								<div class="img_com" >
									<img src="<?php echo $v['litpic']; ?>" style="height: 160px">
								</div>
								<div class="news_com">
									<p class="tit"><?php echo $v['title']; ?></p>
									<span class="time"><?php echo date('Y-m-d',$v['add_time']); ?></span>
									<div class="introd">
										<?php echo mb_substr(strip_tags(htmlspecialchars_decode($v['content'])),0,160); ?>
									</div>
								</div>
							</a>
						</li>
