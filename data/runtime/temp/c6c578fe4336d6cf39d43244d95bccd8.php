<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"./application/admin/template/index\ajax_quickmenu.htm";i:1573115083;s:55:"D:\WWW\ycm\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
<body style="background-color:#F4F4F4;padding:6px; overflow: auto;min-width:auto;">
    ...
    <script type="text/javascript">
        ...
        function check_submit(){
            layer_loading('正在处理');
            $.ajax({
                url: "<?php echo url('Index/ajax_quickmenu', ['_ajax'=>1]); ?>",
                type: 'POST',
                dataType: 'JSON',
