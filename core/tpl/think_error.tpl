...
<img  src="/public/static/common/images/404.png">
<p style="font-size: 30px"> 页面找不到了</p>
<p> <span id="wait">5</span>秒后<a id="href" style="font-size: 20px;color:red" href="/" target="">返回主页 </a></p>
</div>
